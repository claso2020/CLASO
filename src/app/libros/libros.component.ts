...
export class LibrosComponent implements OnInit {
  ...
  displayedColumns: string[] = ['acciones','titulo','autor','editorial','habilitado'];
  ...
  buscarDatos(){
    ...
    dlgTrabajando.componentInstance.texto="Buscando los libros";

    this.httpClient.get(environment.servidorHttp+'Sistema/leerLibros'
      ,{
        params: {
    ...
    (error: HttpErrorResponse) => {
      ...
      if (error.status.toString()=="401"){
        dlgError.componentInstance.titulo="Error al buscar los libros";
  ...
  modificar(idGeneral) {
    ...
    this.router.navigate(['/libros-mod'])
  }
